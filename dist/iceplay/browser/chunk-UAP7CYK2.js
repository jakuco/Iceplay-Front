...
var MatchService = class _MatchService {
  ...
  getScheduleByDate(date) {
    return this.api.get("matches/schedule-by-date", { date }).pipe(catchError((error) => this.handleError("Error fetching matches by date", error)));
  }
  /**
...
//# sourceMappingURL=chunk-UAP7CYK2.js.map
