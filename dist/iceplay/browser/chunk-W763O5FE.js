...
// src/app/features/admin/layouts/admin-layout.ts
var _c0 = () => ({ exact: true });
var _forTrack0 = ($index, $item) => $item.key;
var _forTrack1 = ($index, $item) => $item.route;
function AdminLayout_For_19_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 17);
    \u0275\u0275listener("click", function AdminLayout_For_19_Template_button_click_0_listener() {
...
function AdminLayout_For_47_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 30);
    \u0275\u0275listener("click", function AdminLayout_For_47_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r4 = \u0275\u0275nextContext();
...
var AdminLayout = class _AdminLayout {
  ...
  navItems = [
    ...
    { icon: "bar_chart", label: "Estad\xEDsticas", route: "/admin/statistics" }
  ];
  constructor() {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminLayout, selectors: [["app-admin-layout"]], decls: 61, vars: 10, consts: [["themeMenu", "matMenu"], ["userMenu", "matMenu"], ["sidenav", ""], [1, "layout-wrapper"], [1, "top-header"], [1, "header-brand"], ["matIconButton", "", "aria-label", "Toggle menu", 3, "click"], ["routerLink", "/admin", 1, "logo"], [1, "ice"], [1, "badge"], [1, "header-actions"], ["matIconButton", "", "matTooltip", "Cambiar tema", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "active-theme"], ["matIconButton", "", "matTooltip", "Mi cuenta", 3, "matMenuTriggerFor"], [1, "header-avatar"], [1, "menu-header"], ["mat-menu-item", "", "routerLink", "/"], ["mat-menu-item", "", 3, "click"], [1, "sidenav-container"], [1, "sidenav", 3, "openedChange", "mode", "opened"], [1, "nav-list"], ["mat-list-item", "", "routerLinkActive", "active", 3, "routerLink", "routerLinkActiveOptions"], [1, "sidenav-footer"], [1, "user-info"], [1, "avatar"], [1, "user-details"], [1, "user-name"], [1, "user-role"], [1, "content"], [1, "main-content"], ["mat-list-item", "", "routerLinkActive", "active", 3, "click", "routerLink", "routerLinkActiveOptions"], ["matListItemIcon", ""], ["matListItemTitle", ""]], template: function AdminLayout_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "div", 3)(1, "header", 4)(2, "div", 5)(3, "button", 6);
      \u0275\u0275listener("click", function AdminLayout_Template_button_click_3_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275repeaterCreate(18, AdminLayout_For_19_Template, 5, 4, "button", 12, _forTrack0);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275listener("click", function AdminLayout_Template_button_click_37_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275listener("openedChange", function AdminLayout_Template_mat_sidenav_openedChange_43_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.sidenavOpened.set($event));
      });
      \u0275\u0275elementStart(45, "mat-nav-list", 20);
      \u0275\u0275repeaterCreate(46, AdminLayout_For_47_Template, 5, 5, "a", 21, _forTrack1);
      \u0275\u0275elementEnd();
