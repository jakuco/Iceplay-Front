...
var ThemeService = class _ThemeService {
  ...
  theme = signal(this.getInitialTheme(), __spreadValues({}, ngDevMode ? { debugName: "theme" } : {}));
  // Computed values for easy access
  themeConfig = computed(() => THEMES[this.theme()], __spreadValues({}, ngDevMode ? { debugName: "themeConfig" } : {}));
  isDark = computed(() => this.themeConfig().colorScheme === "dark", __spreadValues({}, ngDevMode ? { debugName: "isDark" } : {}));
  // List of all themes for UI
  availableThemes = Object.entries(THEMES).map(([key, config]) => __spreadValues({
    key
  }, config));
  constructor() {
...
//# sourceMappingURL=chunk-VA2U2E6L.js.map
