...
import type { DbId } from '../../../../core/models/db.types';
import type { Championship } from '../../../../core/models/championship.model';
...
export default class TeamsListPage {
  ...
  private championshipsMap = new Map<DbId, Championship>();
